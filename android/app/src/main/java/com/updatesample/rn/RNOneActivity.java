 ...
 * description:
 */
public class RNOneActivity extends Activity implements DefaultHardwareBackBtnHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String path = getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath() + File.separator + "one" + File.separator + "index.android.bundle";
        ...
        if (file.exists()) {
            reactInstanceManagerBuilder.setJSBundleFile(path);
        } else {
